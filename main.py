...
parser.add_argument('--batch_size', type=int,default=32, nargs='?',help='display an integer')
...
path = r"D:\Users\Administrator\Desktop\DTCA-main\datasets\finetune"
data_input_file = os.path.join(path,task_name,dataset_type,"input.pt")
...
if text_model_name == 'bert':
    ...
    model_path1 = r"D:\Users\Administrator\Desktop\DTCA-main\model\roberta-base\roberta-base"
    config1 = AutoConfig.from_pretrained(model_path1)
...
if image_model_name == 'vit':
    model_path2 = r"D:\Users\Administrator\Desktop\DTCA-main\model\vit-base-patch16-224-in21k"
